...
class UsersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $user1 = User::create( ['id'=>3, "name"=>"Giám đốc sở 1", "email"=>"giamdocso1@gmail.com", "password"=>bcrypt('123456'),"parent_id"=>2, 'hospitals_id'=>1, 'positions_id'=>7]);
        ...
        DB::table('users')->insert(
            [
                ...
                ['id'=>2, "name"=>"Thứ trưởng", "email"=>"thutruong@gmail.com", "password"=>bcrypt('123456'),"parent_id"=>1, 'hospitals_id'=>1, 'positions_id'=>6],
